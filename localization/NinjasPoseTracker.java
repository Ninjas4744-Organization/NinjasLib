...
public class NinjasPoseTracker<T> {
     ...
     * NinjasPoseTracker#update} every loop.
     *
     ...
     *     NinjasPoseTracker#updateWithTime(double,Rotation2d,Object)} then you must use a timestamp with
     ...
     * NinjasPoseTracker#setVisionMeasurementStrength(Matrix)} or this method.
     *
     * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
     * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
    ...
    public void addVisionMeasurement(
        ...
        setVisionMeasurementStrength(visionMeasurementStdDevs);
