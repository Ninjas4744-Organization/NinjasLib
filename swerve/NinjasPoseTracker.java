...
public class NinjasPoseTracker<T> {
    ...
    public NinjasPoseTracker(
        ...
        setMeasurementStdDevs(stateStdDevs, visionMeasurementStdDevs);
    }
    ...
    public final void setStateMeasurementStdDevs(Matrix<N3, N1> stateStdDevs) {
        for (int i = 0; i < 3; ++i) {
            m_q.set(i, 0, stateStdDevs.get(i, 0) * stateStdDevs.get(i, 0));
        }
    }

    public final void setMeasurementStdDevs(Matrix<N3, N1> stateStdDevs, Matrix<N3, N1> visionMeasurementStdDevs) {
        setStateMeasurementStdDevs(stateStdDevs);
